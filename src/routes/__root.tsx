...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "King" },
      { name: "description", content: "King's Login Portal is a secure authentication gateway for a gaming website." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "King" },
      { property: "og:description", content: "King's Login Portal is a secure authentication gateway for a gaming website." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "King" },
